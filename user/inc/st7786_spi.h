...
void st7789SpiShowChar(const unsigned char ch, uint16_t wx, uint16_t hy, St7786Spi4Color18* fg, St7786Spi4Color18* bg, St7786SpiFontSize siz);
void st7789SpiShowStr(const char* ch, int16_t columnSpace, uint16_t wx, uint16_t hy, St7786Spi4Color18* fg, St7786Spi4Color18* bg, St7786SpiFontSize siz);
